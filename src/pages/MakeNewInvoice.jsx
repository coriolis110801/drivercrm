                ...
                <div className={styles.actions}>
                    {
                        state ? (
                            <>
                                <Button block onClick={DownloadPng} type="primary" icon={<LinkOutlined />}>Download</Button>
                                {
                                    state?.readonly?null:(
                                        <>
                                            <Button onClick={EditSave} block type="primary" icon={<CaretDownOutlined />}>Save</Button>
                                            <Button onClick={EditDel} block color="danger" variant="solid" icon={<DeleteOutlined />}>Delete</Button>
                                        </>
                                    )
                                }
                            </>
